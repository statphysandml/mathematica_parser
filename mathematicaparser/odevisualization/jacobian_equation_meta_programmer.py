    ...
    def write_hpp_footer(self):
        ...
        with open(self.header_file, "a") as f:
            f.write('\nclass ' + self.class_name + self.base_struct_name + 's : public flowequations::' + self.base_struct_name + 'sWrapper\n'
                    ...
                    '\t{\n'
                    '\t\tjacobian_equations_ = std::vector<std::shared_ptr<flowequations::' + self.base_struct_name + '>> {\n')
            ...
            f.write('\t}\n\n'
                    ...
                    'private:\n'
                    '\tconst cudaT k_;\n'
                    '\tstd::vector<std::shared_ptr<flowequations::' + self.base_struct_name + '>> jacobian_equations_;\n'
                    '};\n\n'
