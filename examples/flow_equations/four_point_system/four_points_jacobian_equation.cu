...
struct comp_func_four_points0
{
	...
	{
		thrust::get<5>(t) = -2 + ((pow((1 + thrust::get<1>(t)), -4)) * ((thrust::get<3>(t) * (-7 + (32 * (1 + (-2 * thrust::get<0>(t))) * thrust::get<0>(t)))) + (-8 * thrust::get<2>(t) * (-1 + (2 * thrust::get<4>(t))) * (1 + thrust::get<1>(t)))) * const_expr0_);
	}
};
...
struct comp_func_four_points1
{
	...
	void operator()(Tuple t)
	{
		thrust::get<3>(t) = thrust::get<1>(t) * (-1 + (4 * thrust::get<0>(t))) * (pow((1 + thrust::get<2>(t)), -3)) * const_expr0_;
	}
};
...
struct comp_func_four_points3
{
	...
	cudaT operator()(const cudaT &val1, const cudaT &val2)
	{
		return (-12 + ((7 + (32 * val1 * (-1 + (2 * val1)))) * (pow((1 + val2), -3)))) * const_expr0_;
	}
};
...
struct comp_func_four_points5
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow(thrust::get<3>(t), const_expr0_)) * (pow((1 + thrust::get<1>(t)), -6)) * ((15 * (pow(thrust::get<2>(t), const_expr1_)) * (-38 + (67 * thrust::get<0>(t))) * (pow((1 + thrust::get<1>(t)), 3))) + (-30 * (pow(thrust::get<3>(t), const_expr2_)) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((114 * thrust::get<4>(t) * (1 + thrust::get<1>(t))) + (-1 * thrust::get<0>(t) * (15 + (590 * thrust::get<4>(t)) + (15 * thrust::get<1>(t)) + (574 * thrust::get<4>(t) * thrust::get<1>(t)))) + (12 * (pow(thrust::get<0>(t), 2)) * (5 + (9 * thrust::get<4>(t)) + (5 * (1 + thrust::get<4>(t)) * thrust::get<1>(t)))))) + ((pow(thrust::get<3>(t), const_expr1_)) * ((627 * (1 + thrust::get<1>(t))) + (5 * thrust::get<0>(t) * (-885 + (-586 * thrust::get<1>(t)) + (4 * thrust::get<0>(t) * (425 + (-686 * thrust::get<0>(t)) + (2312 * (pow(thrust::get<0>(t), 2))) + (4 * (-5 + (8 * thrust::get<0>(t) * (7 + (54 * thrust::get<0>(t))))) * thrust::get<1>(t))))))))) * const_expr3_;
	}
};
...
struct comp_func_four_points6
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow(thrust::get<3>(t), const_expr0_)) * (pow((1 + thrust::get<1>(t)), -5)) * ((-1005 * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 3))) + (-20 * (pow(thrust::get<3>(t), const_expr2_)) * (1 + thrust::get<1>(t)) * (((pow((1 + thrust::get<1>(t)), 4)) * const_expr3_) + (thrust::get<2>(t) * (15 + (586 * thrust::get<4>(t)) + (15 * thrust::get<1>(t)) + (574 * thrust::get<4>(t) * thrust::get<1>(t)) + (-24 * thrust::get<0>(t) * (5 + (8 * thrust::get<4>(t)) + (5 * (1 + thrust::get<4>(t)) * thrust::get<1>(t)))))))) + ((pow(thrust::get<3>(t), const_expr1_)) * (2138 + (-1680 * (pow(thrust::get<0>(t), 2)) * (-9 + (4 * thrust::get<1>(t)))) + (80 * thrust::get<0>(t) * (-84 + (5 * thrust::get<1>(t)))) + (-256 * (pow(thrust::get<0>(t), 3)) * (343 + (270 * thrust::get<1>(t)))) + (5 * thrust::get<1>(t) * (368 + (15 * thrust::get<1>(t) * (10 + (thrust::get<1>(t) * (10 + (thrust::get<1>(t) * (5 + thrust::get<1>(t)))))))))))) * const_expr4_;
	}
};
...
struct comp_func_four_points7
{
	...
	void operator()(Tuple t)
	{
		thrust::get<3>(t) = thrust::get<2>(t) * (pow((1 + thrust::get<1>(t)), -4)) * ((57 * (1 + thrust::get<1>(t))) + (thrust::get<0>(t) * (-293 + (-287 * thrust::get<1>(t)) + (6 * thrust::get<0>(t) * (8 + (5 * thrust::get<1>(t))))))) * const_expr0_;
	}
};
...
struct comp_func_four_points8
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = (pow(thrust::get<2>(t), const_expr0_)) * (pow((1 + thrust::get<1>(t)), -5)) * ((15 * (pow(thrust::get<3>(t), const_expr1_)) * (-38 + (67 * thrust::get<0>(t))) * (pow((1 + thrust::get<1>(t)), 3))) + ((pow(thrust::get<2>(t), const_expr1_)) * ((-1120 * (pow(thrust::get<0>(t), 3)) * (-9 + (4 * thrust::get<1>(t)))) + (80 * (pow(thrust::get<0>(t), 2)) * (-84 + (5 * thrust::get<1>(t)))) + (-128 * (pow(thrust::get<0>(t), 4)) * (343 + (270 * thrust::get<1>(t)))) + (57 * (1 + thrust::get<1>(t)) * (13 + (24 * thrust::get<1>(t) * (2 + thrust::get<1>(t)) * (2 + (thrust::get<1>(t) * (2 + thrust::get<1>(t))))))) + (2 * thrust::get<0>(t) * (2138 + (5 * thrust::get<1>(t) * (368 + (15 * thrust::get<1>(t) * (10 + (thrust::get<1>(t) * (10 + (thrust::get<1>(t) * (5 + thrust::get<1>(t)))))))))))))) * const_expr2_;
	}
};
...
struct comp_func_four_points9
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow(thrust::get<3>(t), const_expr0_)) * (pow((1 + thrust::get<1>(t)), -4)) * ((-9 * (pow(thrust::get<2>(t), const_expr1_)) * (-38 + (67 * thrust::get<0>(t))) * (pow((1 + thrust::get<1>(t)), 2))) + (8 * (pow(thrust::get<3>(t), const_expr1_)) * ((114 * thrust::get<4>(t) * (1 + thrust::get<1>(t))) + (-1 * thrust::get<0>(t) * (15 + (586 * thrust::get<4>(t)) + (15 * thrust::get<1>(t)) + (574 * thrust::get<4>(t) * thrust::get<1>(t)))) + (12 * (pow(thrust::get<0>(t), 2)) * (5 + (8 * thrust::get<4>(t)) + (5 * (1 + thrust::get<4>(t)) * thrust::get<1>(t))))))) * const_expr2_;
	}
};
...
struct comp_func_four_points13
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = -6 * (pow(thrust::get<2>(t), const_expr0_)) * (pow(thrust::get<3>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * (15318099 + (45656452 * thrust::get<1>(t)) + (4 * thrust::get<0>(t) * (3527699 + (-19686405 * thrust::get<1>(t)) + (3 * thrust::get<0>(t) * (-6453845 + (249079 * thrust::get<1>(t)))))));
	}
};
...
struct comp_func_four_points11
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = -1 * thrust::get<3>(t) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * (19809651 + (-124579062 * thrust::get<4>(t)) + (4 * thrust::get<0>(t) * (-344680080 + (thrust::get<0>(t) * (1343716751 + (-2042942830 * thrust::get<4>(t)))) + (953515386 * thrust::get<4>(t)))) + (-692814214 * thrust::get<1>(t)) + (4 * ((261448352 * thrust::get<4>(t)) + (thrust::get<0>(t) * (308050240 + (571199341 * thrust::get<0>(t)) + (48 * (-13982433 + (7550336 * thrust::get<0>(t))) * thrust::get<4>(t))))) * thrust::get<1>(t)));
	}
};
...
struct comp_func_four_points18
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = 2 * thrust::get<3>(t) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((115103685719070 * (1 + thrust::get<1>(t))) + (20 * thrust::get<4>(t) * ((-10040787 * thrust::get<4>(t) * (-8730291 + (9321622 * thrust::get<1>(t)))) + (88 * (-571875192758 + (255640730419 * thrust::get<1>(t)))))) + (thrust::get<0>(t) * ((-409257549223360 * (1 + thrust::get<1>(t))) + (3 * thrust::get<4>(t) * ((2975048 * thrust::get<4>(t) * (-976169399 + (226510080 * thrust::get<1>(t)))) + (5 * (504191436061413 + (274363798502845 * thrust::get<1>(t)))))))));
	}
};
...
struct comp_func_four_points17
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = -24 * (pow(thrust::get<3>(t), 2)) * ((17788979447497 * (1 + thrust::get<1>(t))) + (1859405 * thrust::get<0>(t) * (-29774297 + (23699265 * thrust::get<1>(t)))) + (10 * thrust::get<2>(t) * ((-5115719365292 * (1 + thrust::get<1>(t))) + (371881 * thrust::get<0>(t) * (241367493 + (11163745 * thrust::get<1>(t)))))) + (8 * (pow(thrust::get<2>(t), 3)) * ((52856369685981 * (1 + thrust::get<1>(t))) + (1859405 * thrust::get<0>(t) * (343963618 + (144422147 * thrust::get<1>(t)))))) + (-6 * (pow(thrust::get<2>(t), 2)) * ((25037084615010 * (1 + thrust::get<1>(t))) + (371881 * thrust::get<0>(t) * (1644117897 + (402397877 * thrust::get<1>(t)))))));
	}
};
...
struct comp_func_four_points16
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = 40 * (pow(thrust::get<3>(t), const_expr0_)) * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * ((-20323631463938 * (1 + thrust::get<1>(t))) + (142126174250336 * thrust::get<0>(t) * (1 + thrust::get<1>(t))) + (6693858 * thrust::get<0>(t) * thrust::get<4>(t) * (-4778114 + (249079 * thrust::get<1>(t)))) + (-3346929 * thrust::get<4>(t) * (758609 + (6562135 * thrust::get<1>(t)))));
	}
};
...
struct comp_func_four_points21
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = thrust::get<3>(t) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((-160 * thrust::get<0>(t) * ((44 * (571875192758 + (-255640730419 * thrust::get<1>(t)))) + (10040787 * thrust::get<4>(t) * (-8730291 + (9321622 * thrust::get<1>(t)))))) + (15 * (-7470553046365 + (-113475063262391 * thrust::get<1>(t)) + (2975048 * thrust::get<4>(t) * (13686929 + (130724176 * thrust::get<1>(t)))))) + (6 * (pow(thrust::get<0>(t), 2)) * ((5950096 * thrust::get<4>(t) * (-976169399 + (226510080 * thrust::get<1>(t)))) + (5 * (504191436061413 + (274363798502845 * thrust::get<1>(t)))))));
	}
};
...
struct comp_func_four_points20
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = 5578215 * (pow(thrust::get<2>(t), const_expr0_)) * (pow(thrust::get<3>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * (91610749 + (182625808 * thrust::get<1>(t)) + (48 * thrust::get<0>(t) * (-758609 + (-6562135 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-4778114 + (249079 * thrust::get<1>(t)))))));
	}
};
...
struct comp_func_four_points26
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = 1115643 * thrust::get<4>(t) * ((-15 * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * (91610749 + (182625808 * thrust::get<1>(t)) + (48 * thrust::get<0>(t) * (-758609 + (-6562135 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-4778114 + (249079 * thrust::get<1>(t)))))))) + (-6 * (pow(thrust::get<3>(t), const_expr2_)) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((5 * (-61357561 + (54747716 * thrust::get<4>(t)) + (-346407107 * thrust::get<1>(t)) + (522896704 * thrust::get<4>(t) * thrust::get<1>(t)))) + (2 * (pow(thrust::get<0>(t), 2)) * (5946066345 + (-7809355192 * thrust::get<4>(t)) + (5 * (571199341 + (362416128 * thrust::get<4>(t))) * thrust::get<1>(t)))) + (-80 * thrust::get<0>(t) * (26766752 + (-38506280 * thrust::get<1>(t)) + (9 * thrust::get<4>(t) * (-8730291 + (9321622 * thrust::get<1>(t)))))))) + (12 * (pow(thrust::get<3>(t), const_expr1_)) * (130409755 + (-89131340 * thrust::get<1>(t)) + (16 * ((5 * (pow(thrust::get<0>(t), 2)) * (241367493 + (11163745 * thrust::get<1>(t)))) + (5 * thrust::get<0>(t) * (-29774297 + (23699265 * thrust::get<1>(t)))) + (10 * (pow(thrust::get<0>(t), 4)) * (343963618 + (144422147 * thrust::get<1>(t)))) + (-2 * (pow(thrust::get<0>(t), 3)) * (1644117897 + (402397877 * thrust::get<1>(t)))) + (4289082 * (pow(thrust::get<1>(t), 2)) * (15 + (thrust::get<1>(t) * (20 + (thrust::get<1>(t) * (15 + (thrust::get<1>(t) * (6 + thrust::get<1>(t))))))))))))));
	}
};
...
struct comp_func_four_points25
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = -40894566 * (1 + thrust::get<1>(t)) * ((6 * (pow(thrust::get<3>(t), const_expr1_)) * (6706343 + (-16 * thrust::get<0>(t) * (2609977 + (2 * thrust::get<0>(t) * (-1876430 + (-3673410 * thrust::get<0>(t)) + (7755021 * (pow(thrust::get<0>(t), 2))))))))) + (-4 * (pow(thrust::get<3>(t), const_expr2_)) * thrust::get<2>(t) * (3940503 + (-68164380 * (pow(thrust::get<0>(t), 2)) * thrust::get<4>(t)) + (-8443935 * ((2 * thrust::get<0>(t)) + thrust::get<4>(t))) + (30022880 * thrust::get<0>(t) * (thrust::get<0>(t) + (2 * thrust::get<4>(t))))) * (1 + thrust::get<1>(t))) + (5 * (pow(thrust::get<2>(t), const_expr1_)) * (1313501 + (16 * thrust::get<0>(t) * (-1490929 + (5213144 * thrust::get<0>(t))))) * (pow((1 + thrust::get<1>(t)), 2))) + (-104262880 * (pow(thrust::get<3>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 5))));
	}
};
...
struct comp_func_four_points30
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = 2 * (pow(thrust::get<2>(t), 2)) * ((240 * (pow(thrust::get<1>(t), 2)) * ((-5115719365292 * (1 + thrust::get<3>(t))) + (371881 * thrust::get<0>(t) * (241367493 + (11163745 * thrust::get<3>(t)))))) + (48 * thrust::get<1>(t) * ((17788979447497 * (1 + thrust::get<3>(t))) + (1859405 * thrust::get<0>(t) * (-29774297 + (23699265 * thrust::get<3>(t)))))) + (96 * (pow(thrust::get<1>(t), 4)) * ((52856369685981 * (1 + thrust::get<3>(t))) + (1859405 * thrust::get<0>(t) * (343963618 + (144422147 * thrust::get<3>(t)))))) + (-96 * (pow(thrust::get<1>(t), 3)) * ((25037084615010 * (1 + thrust::get<3>(t))) + (371881 * thrust::get<0>(t) * (1644117897 + (402397877 * thrust::get<3>(t)))))) + (6815761 * (1 + thrust::get<3>(t)) * (32012411 + (52131440 * thrust::get<3>(t) * (5 + (thrust::get<3>(t) * (10 + (thrust::get<3>(t) * (10 + (thrust::get<3>(t) * (5 + thrust::get<3>(t))))))))))) + (1115643 * thrust::get<0>(t) * (130409755 + (4 * thrust::get<3>(t) * (-22282835 + (17156328 * thrust::get<3>(t) * (15 + (thrust::get<3>(t) * (20 + (thrust::get<3>(t) * (15 + (thrust::get<3>(t) * (6 + thrust::get<3>(t))))))))))))));
	}
};
...
struct comp_func_four_points29
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = 10 * (pow(thrust::get<3>(t), 2)) * (pow((1 + thrust::get<1>(t)), 2)) * ((167565525079566 * thrust::get<0>(t) * (pow((1 + thrust::get<1>(t)), 2))) + (-20447283 * (1 + thrust::get<1>(t)) * (2418929 + (2981858 * thrust::get<1>(t)))) + (53550864 * (pow(thrust::get<2>(t), 3)) * (718663 + (4288805 * thrust::get<1>(t)))) + ((pow(thrust::get<2>(t), 2)) * (654698538856964 + (454396744349060 * thrust::get<1>(t)))) + (-9 * thrust::get<2>(t) * (22851632995047 + (thrust::get<1>(t) * (27096679526074 + (12208992685375 * thrust::get<1>(t)))))));
	}
};
...
struct comp_func_four_points28
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = 5 * (pow(thrust::get<3>(t), const_expr0_)) * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * ((17905017778522 * (1 + thrust::get<1>(t))) + (1115643 * thrust::get<4>(t) * (91610749 + (182625808 * thrust::get<1>(t)))) + (16 * (pow(thrust::get<0>(t), 2)) * ((71063087125168 * (1 + thrust::get<1>(t))) + (3346929 * thrust::get<4>(t) * (-4778114 + (249079 * thrust::get<1>(t)))))) + (-16 * thrust::get<0>(t) * ((20323631463938 * (1 + thrust::get<1>(t))) + (3346929 * thrust::get<4>(t) * (758609 + (6562135 * thrust::get<1>(t)))))));
	}
};
...
struct comp_func_four_points31
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow((1 + thrust::get<1>(t)), -6)) * ((282 * (pow(thrust::get<3>(t), const_expr0_)) * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 3))) + (12 * thrust::get<3>(t) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((-15 * (1 + thrust::get<1>(t))) + (-2 * thrust::get<4>(t) * (67 + (59 * thrust::get<1>(t)))) + (12 * thrust::get<0>(t) * (5 + (9 * thrust::get<4>(t)) + (5 * (1 + thrust::get<4>(t)) * thrust::get<1>(t)))))) + (-2 * (pow(thrust::get<3>(t), 2)) * (-201 + (98 * thrust::get<1>(t)) + (4 * thrust::get<0>(t) * (197 + (-248 * thrust::get<1>(t)) + (2 * thrust::get<0>(t) * (-286 + (169 * thrust::get<1>(t)) + (4 * thrust::get<0>(t) * (289 + (216 * thrust::get<1>(t))))))))))) * const_expr2_;
	}
};
...
struct comp_func_four_points32
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = thrust::get<3>(t) * (pow((1 + thrust::get<1>(t)), -5)) * ((-30 * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * (5 + (8 * thrust::get<4>(t)) + (5 * (1 + thrust::get<4>(t)) * thrust::get<1>(t)))) + (thrust::get<3>(t) * (135 + (-310 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-975 + (845 * thrust::get<1>(t)) + (24 * thrust::get<0>(t) * (343 + (270 * thrust::get<1>(t))))))))) * const_expr0_;
	}
};
...
struct comp_func_four_points33
{
	...
	void operator()(Tuple t)
	{
		thrust::get<4>(t) = thrust::get<2>(t) * thrust::get<3>(t) * (pow((1 + thrust::get<1>(t)), -4)) * (-65 + (-59 * thrust::get<1>(t)) + (6 * thrust::get<0>(t) * (8 + (5 * thrust::get<1>(t))))) * const_expr0_;
	}
};
...
struct comp_func_four_points34
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = 2 + (((-10 * thrust::get<3>(t)) + (const_expr0_ * thrust::get<3>(t) * (-299 + (4 * thrust::get<0>(t) * (445 + (-910 * thrust::get<0>(t)) + (584 * (pow(thrust::get<0>(t), 2)))))) * (pow((1 + thrust::get<1>(t)), -5))) + (const_expr1_ * thrust::get<3>(t) * (49 + (4 * thrust::get<0>(t) * (-124 + (thrust::get<0>(t) * (169 + (864 * thrust::get<0>(t))))))) * (pow((1 + thrust::get<1>(t)), -4))) + (16 * thrust::get<2>(t) * (1 + (-3 * thrust::get<0>(t))) * thrust::get<4>(t) * (pow((1 + thrust::get<1>(t)), -4))) + (const_expr2_ * thrust::get<2>(t) * (15 + (118 * thrust::get<4>(t)) + (-60 * thrust::get<0>(t) * (1 + thrust::get<4>(t)))) * (pow((1 + thrust::get<1>(t)), -3))) + (const_expr3_ * (pow(thrust::get<3>(t), const_expr4_)) * (pow(thrust::get<2>(t), const_expr5_)) * (pow((1 + thrust::get<1>(t)), -2)))) * const_expr6_);
	}
};
...
struct comp_func_four_points35
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow((1 + thrust::get<1>(t)), -4)) * ((120 * thrust::get<3>(t) * (1 + thrust::get<1>(t))) + (-423 * (pow(thrust::get<3>(t), const_expr0_)) * (pow(thrust::get<2>(t), const_expr0_)) * (pow((1 + thrust::get<1>(t)), 2))) + (16 * thrust::get<3>(t) * thrust::get<4>(t) * (65 + (59 * thrust::get<1>(t)))) + (-96 * thrust::get<3>(t) * thrust::get<0>(t) * (5 + (8 * thrust::get<4>(t)) + (5 * (1 + thrust::get<4>(t)) * thrust::get<1>(t))))) * const_expr1_;
	}
};
...
struct comp_func_four_points41
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow((1 + thrust::get<1>(t)), -6)) * ((120 * (pow(thrust::get<3>(t), const_expr0_)) * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * (-758609 + (-6562135 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-9556228 + (498158 * thrust::get<1>(t)))))) + (2 * thrust::get<3>(t) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((thrust::get<0>(t) * (5946066345 + (-7809355192 * thrust::get<4>(t)) + (5 * (571199341 + (362416128 * thrust::get<4>(t))) * thrust::get<1>(t)))) + (-20 * (26766752 + (-38506280 * thrust::get<1>(t)) + (9 * thrust::get<4>(t) * (-8730291 + (9321622 * thrust::get<1>(t)))))))) + (-8 * (pow(thrust::get<3>(t), 2)) * ((5 * (-29774297 + (23699265 * thrust::get<1>(t)))) + (2 * thrust::get<0>(t) * (1206837465 + (55818725 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-4932353691 + (6879272360 * thrust::get<0>(t)) + (59 * (-20460909 + (48956660 * thrust::get<0>(t))) * thrust::get<1>(t))))))))) * const_expr2_;
	}
};
...
struct comp_func_four_points42
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = thrust::get<2>(t) * (pow((1 + thrust::get<1>(t)), -5)) * ((5 * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * (60209401 + (15324569 * thrust::get<1>(t)) + (24 * thrust::get<4>(t) * (718663 + (4288805 * thrust::get<1>(t)))))) + (thrust::get<3>(t) * (68434645 + (653620880 * thrust::get<1>(t)) + (4 * thrust::get<0>(t) * (392863095 + (-976169399 * thrust::get<0>(t)) + (30 * (-13982433 + (7550336 * thrust::get<0>(t))) * thrust::get<1>(t))))))) * const_expr0_;
	}
};
...
struct comp_func_four_points43
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow(thrust::get<3>(t), const_expr0_)) * (pow((1 + thrust::get<1>(t)), -6)) * ((5 * (pow(thrust::get<2>(t), const_expr1_)) * (pow((1 + thrust::get<1>(t)), 2)) * (91610749 + (182625808 * thrust::get<1>(t)) + (48 * thrust::get<0>(t) * (-758609 + (-6562135 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-4778114 + (249079 * thrust::get<1>(t)))))))) + (2 * (pow(thrust::get<3>(t), const_expr2_)) * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * ((5 * (-61357561 + (54747716 * thrust::get<4>(t)) + (-346407107 * thrust::get<1>(t)) + (522896704 * thrust::get<4>(t) * thrust::get<1>(t)))) + (2 * (pow(thrust::get<0>(t), 2)) * (5946066345 + (-7809355192 * thrust::get<4>(t)) + (5 * (571199341 + (362416128 * thrust::get<4>(t))) * thrust::get<1>(t)))) + (-80 * thrust::get<0>(t) * (26766752 + (-38506280 * thrust::get<1>(t)) + (9 * thrust::get<4>(t) * (-8730291 + (9321622 * thrust::get<1>(t)))))))) + (-4 * (pow(thrust::get<3>(t), const_expr1_)) * (130409755 + (-89131340 * thrust::get<1>(t)) + (16 * ((5 * (pow(thrust::get<0>(t), 2)) * (241367493 + (11163745 * thrust::get<1>(t)))) + (5 * thrust::get<0>(t) * (-29774297 + (23699265 * thrust::get<1>(t)))) + (10 * (pow(thrust::get<0>(t), 4)) * (343963618 + (144422147 * thrust::get<1>(t)))) + (-2 * (pow(thrust::get<0>(t), 3)) * (1644117897 + (402397877 * thrust::get<1>(t)))) + (4289082 * (pow(thrust::get<1>(t), 2)) * (15 + (thrust::get<1>(t) * (20 + (thrust::get<1>(t) * (15 + (thrust::get<1>(t) * (6 + thrust::get<1>(t)))))))))))))) * const_expr3_;
	}
};
...
struct comp_func_four_points44
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (pow((1 + thrust::get<1>(t)), -5)) * (((pow((1 + thrust::get<1>(t)), 5)) * const_expr1_) + (20 * thrust::get<2>(t) * (1 + thrust::get<1>(t)) * (-442988327 + (144 * (pow(thrust::get<4>(t), 2)) * (718663 + (4288805 * thrust::get<1>(t)))) + (12 * thrust::get<4>(t) * (60209401 + (15324569 * thrust::get<1>(t)))) + (-5 * thrust::get<1>(t) * (109144786 + (59094675 * thrust::get<1>(t)))))) + (45 * (pow(thrust::get<3>(t), const_expr0_)) * (pow(thrust::get<2>(t), const_expr0_)) * (1 + thrust::get<1>(t)) * (91610749 + (182625808 * thrust::get<1>(t)) + (48 * thrust::get<0>(t) * (-758609 + (-6562135 * thrust::get<1>(t)) + (thrust::get<0>(t) * (-4778114 + (249079 * thrust::get<1>(t)))))))) + (6 * thrust::get<3>(t) * ((5 * (-61357561 + (54747716 * thrust::get<4>(t)) + (-346407107 * thrust::get<1>(t)) + (522896704 * thrust::get<4>(t) * thrust::get<1>(t)))) + (2 * (pow(thrust::get<0>(t), 2)) * (5946066345 + (-7809355192 * thrust::get<4>(t)) + (5 * (571199341 + (362416128 * thrust::get<4>(t))) * thrust::get<1>(t)))) + (-80 * thrust::get<0>(t) * (26766752 + (-38506280 * thrust::get<1>(t)) + (9 * thrust::get<4>(t) * (-8730291 + (9321622 * thrust::get<1>(t))))))))) * const_expr2_;
	}
};
