#ifndef PROJECT_FOURPOINTSFLOWEQUATION_HPP
#define PROJECT_FOURPOINTSFLOWEQUATION_HPP
...
struct FourPointsFlowEquation0 : public odesolver::flowequations::FlowEquation
{
	FourPointsFlowEquation0(const cudaT k) : k_(k),
...
struct FourPointsFlowEquation1 : public odesolver::flowequations::FlowEquation
{
	FourPointsFlowEquation1(const cudaT k) : k_(k),
...
struct FourPointsFlowEquation2 : public odesolver::flowequations::FlowEquation
{
	FourPointsFlowEquation2(const cudaT k) : k_(k),
...
struct FourPointsFlowEquation3 : public odesolver::flowequations::FlowEquation
{
	FourPointsFlowEquation3(const cudaT k) : k_(k),
		const_expr0_(1*1.0/2),
		const_expr1_(3*1.0/2),
		const_expr2_(-2*1.0/15),
...
struct FourPointsFlowEquation4 : public odesolver::flowequations::FlowEquation
{
	FourPointsFlowEquation4(const cudaT k) : k_(k),
		const_expr0_(1*1.0/2),
...
class FourPointsFlowEquations : public odesolver::flowequations::FlowEquationsWrapper
{
public:
	FourPointsFlowEquations(const cudaT k) : k_(k)
	{
		flow_equations_ = std::vector<std::shared_ptr<odesolver::flowequations::FlowEquation>> {
			std::make_shared<FourPointsFlowEquation0>(k_),
			std::make_shared<FourPointsFlowEquation1>(k_),
			std::make_shared<FourPointsFlowEquation2>(k_),
			std::make_shared<FourPointsFlowEquation3>(k_),
			std::make_shared<FourPointsFlowEquation4>(k_)
		};
	}
...
#endif //PROJECT_FOURPOINTSFLOWEQUATION_HPP
