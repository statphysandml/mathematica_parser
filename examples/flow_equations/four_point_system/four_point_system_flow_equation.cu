...
struct comp_func_four_point_system1
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = thrust::get<2>(t) + thrust::get<1>(t) + thrust::get<4>(t) + thrust::get<3>(t) + thrust::get<0>(t);
	}
};
...
void FourPointSystemFlowEquation1::operator() (odesolver::DimensionIteratorC &derivatives, const odesolver::DevDatC &variables)
{
	...
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[0].begin(), variables[4].begin(), variables[3].begin(), variables[2].begin(), inter_med_vec0.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[0].end(), variables[4].end(), variables[3].end(), variables[2].end(), inter_med_vec0.end())), comp_func_four_point_system6(const_expr0_, const_expr10_, const_expr1_, const_expr2_, const_expr3_, const_expr4_, const_expr5_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec3.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec3.end())), comp_func_four_point_system5(const_expr0_, const_expr1_, const_expr9_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec4.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[0].end(), variables[4].end(), inter_med_vec4.end())), comp_func_four_point_system4(const_expr8_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec1.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec1.end())), comp_func_four_point_system3(const_expr7_));
	thrust::transform(variables[3].begin(), variables[3].end(), inter_med_vec2.begin(), comp_func_four_point_system2(const_expr6_));
...
struct comp_func_four_point_system11
{
	...
	void operator()(Tuple t)
	{
		thrust::get<9>(t) = thrust::get<8>(t) + thrust::get<4>(t) + thrust::get<2>(t) + thrust::get<7>(t) + thrust::get<1>(t) + thrust::get<5>(t) + thrust::get<6>(t) + thrust::get<3>(t) + thrust::get<0>(t);
	}
};
...
struct comp_func_four_point_system7
{
	...
	void operator()(Tuple t)
	{
		thrust::get<9>(t) = (((20852576 * (pow(thrust::get<4>(t), 2)) * (pow(thrust::get<3>(t), -1))) + (const_expr0_ * (pow(thrust::get<4>(t), 2)) * (pow(thrust::get<3>(t), -1)) * (-40238058 + (250557792 * thrust::get<0>(t)) + (-360274560 * (pow(thrust::get<0>(t), 2))) + (-705294720 * (pow(thrust::get<0>(t), 3))) + (1488964032 * (pow(thrust::get<0>(t), 4)))) * (pow((1 + thrust::get<2>(t)), -5))) + (const_expr1_ * thrust::get<4>(t) * (15762012 + (-272657520 * (pow(thrust::get<0>(t), 2)) * thrust::get<6>(t)) + (-33775740 * ((2 * thrust::get<0>(t)) + thrust::get<6>(t))) + (120091520 * thrust::get<0>(t) * (thrust::get<0>(t) + (2 * thrust::get<6>(t))))) * (pow((1 + thrust::get<2>(t)), -4))) + (const_expr2_ * (pow(thrust::get<4>(t), const_expr3_)) * (pow(thrust::get<3>(t), const_expr3_)) * (-39405030 + (715645920 * thrust::get<0>(t)) + (-2502309120 * (pow(thrust::get<0>(t), 2)))) * (pow((1 + thrust::get<2>(t)), -3))) + (const_expr4_ * thrust::get<3>(t) * (-50663610 + (180137280 * thrust::get<6>(t)) + (-1699046160 * (pow(thrust::get<6>(t), 2)))) * (pow((1 + thrust::get<2>(t)), -3))) + (const_expr3_ * thrust::get<3>(t) * (35782296 + (-98340024 * thrust::get<0>(t))) * (pow((1 + thrust::get<2>(t)), -2)))) * const_expr5_) + (-1 * (pow(thrust::get<3>(t), -1)) * thrust::get<6>(t) * ((2 * thrust::get<3>(t)) + (thrust::get<3>(t) * (thrust::get<5>(t) + thrust::get<7>(t) + thrust::get<1>(t) + thrust::get<8>(t)) * const_expr17_)));
	}
};
...
void FourPointSystemFlowEquation2::operator() (odesolver::DimensionIteratorC &derivatives, const odesolver::DevDatC &variables)
{
	...
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec3.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec3.end())), comp_func_four_point_system20(const_expr13_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec4.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[0].end(), variables[4].end(), inter_med_vec4.end())), comp_func_four_point_system19(const_expr12_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec7.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec7.end())), comp_func_four_point_system18(const_expr11_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec6.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec6.end())), comp_func_four_point_system17(const_expr10_, const_expr3_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec2.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec2.end())), comp_func_four_point_system16(const_expr9_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec8.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec8.end())), comp_func_four_point_system15(const_expr9_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec1.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec1.end())), comp_func_four_point_system14(const_expr8_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec5.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec5.end())), comp_func_four_point_system13(const_expr7_));
	thrust::transform(variables[3].begin(), variables[3].end(), variables[4].begin(), inter_med_vec9.begin(), comp_func_four_point_system12(const_expr6_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(inter_med_vec3.begin(), inter_med_vec2.begin(), inter_med_vec1.begin(), inter_med_vec4.begin(), inter_med_vec5.begin(), inter_med_vec6.begin(), inter_med_vec7.begin(), inter_med_vec8.begin(), inter_med_vec9.begin(), inter_med_vec3.begin())),thrust::make_zip_iterator(thrust::make_tuple(inter_med_vec3.end(), inter_med_vec2.end(), inter_med_vec1.end(), inter_med_vec4.end(), inter_med_vec5.end(), inter_med_vec6.end(), inter_med_vec7.end(), inter_med_vec8.end(), inter_med_vec9.end(), inter_med_vec3.end())), comp_func_four_point_system11());
	...
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec2.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[0].end(), variables[4].end(), inter_med_vec2.end())), comp_func_four_point_system9(const_expr15_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec1.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec1.end())), comp_func_four_point_system8(const_expr14_, const_expr3_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), inter_med_vec0.begin(), variables[0].begin(), variables[4].begin(), variables[3].begin(), inter_med_vec1.begin(), variables[2].begin(), inter_med_vec2.begin(), inter_med_vec3.begin(), derivatives.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), inter_med_vec0.end(), variables[0].end(), variables[4].end(), variables[3].end(), inter_med_vec1.end(), variables[2].end(), inter_med_vec2.end(), inter_med_vec3.end(), derivatives.end())), comp_func_four_point_system7(const_expr0_, const_expr17_, const_expr1_, const_expr2_, const_expr3_, const_expr4_, const_expr5_));
}
...
struct comp_func_four_point_system26
{
	...
	void operator()(Tuple t)
	{
		thrust::get<9>(t) = thrust::get<6>(t) + thrust::get<4>(t) + thrust::get<3>(t) + thrust::get<0>(t) + thrust::get<1>(t) + thrust::get<5>(t) + thrust::get<2>(t) + thrust::get<8>(t) + thrust::get<7>(t);
	}
};
...
struct comp_func_four_point_system22
{
	...
	void operator()(Tuple t)
	{
		thrust::get<5>(t) = (2 * thrust::get<2>(t)) + (thrust::get<2>(t) * (thrust::get<1>(t) + thrust::get<4>(t) + thrust::get<3>(t) + thrust::get<0>(t)) * const_expr12_);
	}
};
...
void FourPointSystemFlowEquation4::operator() (odesolver::DimensionIteratorC &derivatives, const odesolver::DevDatC &variables)
{
	...
	dev_vec inter_med_vec8(derivatives.size());
	dev_vec inter_med_vec9(derivatives.size());
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec8.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec8.end())), comp_func_four_point_system35(const_expr8_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec9.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[0].end(), variables[4].end(), inter_med_vec9.end())), comp_func_four_point_system34(const_expr7_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec1.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec1.end())), comp_func_four_point_system33(const_expr6_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec6.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec6.end())), comp_func_four_point_system32(const_expr0_, const_expr5_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec2.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec2.end())), comp_func_four_point_system31(const_expr4_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[2].begin(), variables[1].begin(), variables[3].begin(), variables[0].begin(), inter_med_vec3.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[2].end(), variables[1].end(), variables[3].end(), variables[0].end(), inter_med_vec3.end())), comp_func_four_point_system30(const_expr4_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec4.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec4.end())), comp_func_four_point_system29(const_expr3_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec5.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec5.end())), comp_func_four_point_system28(const_expr2_));
	thrust::transform(variables[3].begin(), variables[3].end(), variables[4].begin(), inter_med_vec7.begin(), comp_func_four_point_system27(const_expr1_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(inter_med_vec3.begin(), inter_med_vec2.begin(), inter_med_vec1.begin(), inter_med_vec4.begin(), inter_med_vec5.begin(), inter_med_vec6.begin(), inter_med_vec7.begin(), inter_med_vec8.begin(), inter_med_vec9.begin(), inter_med_vec0.begin())),thrust::make_zip_iterator(thrust::make_tuple(inter_med_vec3.end(), inter_med_vec2.end(), inter_med_vec1.end(), inter_med_vec4.end(), inter_med_vec5.end(), inter_med_vec6.end(), inter_med_vec7.end(), inter_med_vec8.end(), inter_med_vec9.end(), inter_med_vec0.end())), comp_func_four_point_system26());
	thrust::transform(variables[0].begin(), variables[0].end(), variables[4].begin(), inter_med_vec2.begin(), comp_func_four_point_system25(const_expr11_));
	...
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(variables[1].begin(), variables[3].begin(), variables[0].begin(), variables[4].begin(), inter_med_vec1.begin())),thrust::make_zip_iterator(thrust::make_tuple(variables[1].end(), variables[3].end(), variables[0].end(), variables[4].end(), inter_med_vec1.end())), comp_func_four_point_system23(const_expr0_, const_expr9_));
	thrust::for_each(thrust::make_zip_iterator(thrust::make_tuple(inter_med_vec0.begin(), inter_med_vec1.begin(), variables[4].begin(), inter_med_vec2.begin(), inter_med_vec3.begin(), derivatives.begin())),thrust::make_zip_iterator(thrust::make_tuple(inter_med_vec0.end(), inter_med_vec1.end(), variables[4].end(), inter_med_vec2.end(), inter_med_vec3.end(), derivatives.end())), comp_func_four_point_system22(const_expr12_));
}
